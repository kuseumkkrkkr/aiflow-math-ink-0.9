...
현재 배치 코드 기준 직접 수집 수식 완전일치는 69/95(72.63%)에서 71/95(74.74%), 문자 Top-1은 346/387(89.41%)에서 348/387(89.92%)로 올랐고 회귀는 0건이다. CROHME 반복 진단은 283/984에서 284/984로 1식 증가했으며 관계·문자 동시 완전일치는 225/984에서 226/984가 됐다. 직접 수집 Top-5 수식 oracle이 77/95(81.05%)라서 남은 18식은 이 후단만으로 해결할 수 없다. 반복 관찰 데이터로 규칙을 정했으므로 제품 기본값이 아니라 `shadow_runtime_only`이며, 구현·평가·SHA는 [reports/FORMULA_SYNTAX_RESCUE_LOOP_20260819.md](reports/FORMULA_SYNTAX_RESCUE_LOOP_20260819.md)에 기록했다.
