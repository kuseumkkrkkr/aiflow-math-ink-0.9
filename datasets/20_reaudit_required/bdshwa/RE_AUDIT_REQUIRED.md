# BDSHWA re-audit result: structurally valid, high-risk and out of scope

Audited 2026-08-10 from Mendeley Data version 1. The online trajectories are real and readable, but biometric/privacy, metadata, and corpus-role issues keep the dataset out of AIFlow Math Ink 1.0 training.
...
1. Commercial-product use of demographic and biometric trajectories needs an independent privacy/consent review despite the copyright licence.
2. Participant metadata contains an ID collision and the derived schemas/modalities are inconsistent.
3. The corpus is designed for writer identification, gender, and age inference, which is unnecessary and high risk for AIFlow's mathematical HWR purpose.
4. It does not provide mathematical symbols, formula structure, stroke ownership, or relation labels.

Decision: **BLOCKED - do not train, validate, or derive demographic/identity features.**
