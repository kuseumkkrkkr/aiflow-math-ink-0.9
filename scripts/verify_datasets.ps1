...
$expected = [ordered]@{
  ...
  '20_reaudit_required\isgl_online_offline_hwr\raw\isgl_source.zip' = 'A94F2473246222F9470D4B93B68CFBC756ECB4865742DB8164788359FE511693'
  ...
  '20_reaudit_required\uci_character_trajectories\raw\character+trajectories.official.zip' = '5D2DB017EF0D8CF0E65ED060C9E90399F78EB9F1E3CB63E22CA8C3EF4BA67D52'
  '20_reaudit_required\hwrt\raw\2015-01-28-data.tar' = 'B96FEAFD71B01F1623997DFF3CC8AC4D18628D128CEE1B3DF1880518BBA3EA4A'
  '20_reaudit_required\bdshwa\raw\bdshwa_v1.zip' = '45FBBDCD1A9C4353F5C93BF8096FBEE9723931185F7BBFED3A86E21BA4CF20EA'
...
$largeArtifactLengths = @{
  '20_reaudit_required\isgl_online_offline_hwr\raw\isgl_source.zip' = [int64]974053582
  '20_reaudit_required\hwrt\raw\2015-01-28-data.tar' = [int64]140790596
  '20_reaudit_required\bdshwa\raw\bdshwa_v1.zip' = [int64]1318392171
}
...
$zipFiles = @(
  ...
  '20_reaudit_required\isgl_online_offline_hwr\raw\isgl_source.zip',
  '20_reaudit_required\uci_character_trajectories\raw\character_trajectories.zip',
  '20_reaudit_required\uci_character_trajectories\raw\character+trajectories.official.zip',
  '20_reaudit_required\bdshwa\raw\bdshwa_v1.zip'
)
...
$tarPath = Join-Path $resolvedDatasetRoot '20_reaudit_required\hwrt\raw\2015-01-28-data.tar'
...
Write-Output "Verified $($expected.Count) D: artifacts ($hashedCount hashes, $sizeOnlyCount audited large-file lengths), five ZIP catalogs, two GZIPs, one TAR, and nine Parquet files in $mode mode."
